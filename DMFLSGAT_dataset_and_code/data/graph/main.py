...
if __name__ == '__main__':
    import sys
    sys.path.append(r'C:\Users\DELL\Downloads\DMFGAM_data_and_code12\DMFLSGAT_dataset_and_code\data')
    import matplotlib.pyplot as plt
    import seaborn as sns
    import torch
    from DMFLSGAT_dataset_and_code.data.graph.DMFLSGATUtils import load_data_with_smiles, set_seed, load_fp
    from torch.utils.data import DataLoader
    from DMFLSGAT_dataset_and_code.data.graph.DMFLSGATUtils import SmilesUtils, MyDataset
    import pandas as pd
    from sklearn.metrics import roc_auc_score, accuracy_score, confusion_matrix, roc_curve, auc
    import numpy as np
    from DMFLSGAT_dataset_and_code.data.graph.DMFLSGAT import MyModel
    ...
    PubchemFP881_path = r'C:\Users\DELL\Downloads\DMFGAM_data_and_code12\DMFLSGAT_dataset_and_code\data\FP\PubchemFP881.csv'
    Topological_torsion_path = r'C:\Users\DELL\Downloads\DMFGAM_data_and_code12\DMFLSGAT_dataset_and_code\data\FP\topological_torsion_fingerprints.csv'
    APC2D780_path = r'C:\Users\DELL\Downloads\DMFGAM_data_and_code12\DMFLSGAT_dataset_and_code\data\FP\APC2D780.csv'
    KR_path = r'C:\Users\DELL\Downloads\DMFGAM_data_and_code12\DMFLSGAT_dataset_and_code\data\FP\KR.csv'
    ...
    plt.tight_layout()
    plt.savefig("confusion_matrix-tdmflsgat.png", dpi=300)
    plt.show()
    ...
    fig.tight_layout()
    plt.show()
    fig.savefig("lime_explanation_sample.png")